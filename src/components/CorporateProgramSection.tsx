...
const CorporateProgramSection: React.FC = () => (
  <section id="corporate" className="w-full py-28 bg-yellow-400 text-black">
    <div className="max-w-5xl mx-auto px-4">
      ...
      <p className="text-lg sm:text-xl mb-6">
        We have been delivering travel services par excellence for the past 5
        years. Cozy Cabz is a well-known name for catering best and qualitative
        travel services in the industry. Our growth chart simply portrays the
        trust and positive sentiments of our corporate clients. We have extended
        our services in around 90+ cities of India and currently have 50+
        corporate clients.
      </p>
      <p className="text-base sm:text-lg mb-6">
        We understand that everyday travel plays an important role in life as
        well as the productivity of a person and hence try our best to provide a
        seamless experience in the journey. Our customer support is available at
        your disposal round the clock and every inquiry is answered instantly.
      </p>
      <p className="text-base sm:text-lg mb-6">
